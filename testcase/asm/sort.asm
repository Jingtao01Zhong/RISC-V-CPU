00010148 <main>:
   ...
   10184:	00178793          	addi	a5,a5,1                a5 = 30
   10188:	fef42623          	sw	a5,-20(s0)                 store addr = 3820
   1018c:	fec42703          	lw	a4,-20(s0)                  a4 = 30
   10190:	01d00793          	li	a5,29        (add) no delay a5 = 29
   10194:	fce7d6e3          	ble	a4,a5,10160 <main+0x18> 
   10198:	f7440793          	addi	a5,s0,-140  /////generate a delay? why? 
   1019c:	01e00593          	li	a1,30 ////////////////////////////// error
   101a0:	00078513          	mv	a0,a5
   101a4:	01c000ef          	jal	101c0 <sort>   ///////////////////////////////// jump to sort
